// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["heimuer", "ffzy", "tyyszy", "zy360", "wolong", "hwba", "jisu", "dbzy", "bfzy", "mozhua", "mdzy", "ruyi", "zuid", "yinghua", "baidu", "wwzy", "ikun", "dyttzy", "huya", "wujin"]'); // 默认选中天涯资源、暴风资源和如意资源
