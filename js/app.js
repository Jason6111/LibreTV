// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["heimuer", "ffzy", "tyyszy", "zy360", "wolong", "hwba", "jisu", "dbzy", "bfzy", "mozhua", "mdzy", "ruyi", "zuid"]'); // 默认选中黑木耳和豆瓣资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 仅选择黑木耳源和豆瓣资源
        selectedAPIs = ["heimuer", "ffzy", "tyyszy", "zy360", "wolong", "hwba", "jisu", "dbzy", "bfzy", "mozhua", "mdzy", "ruyi", "zuid"];
